...
def chunk_act_obs(traj: Dict, window_size: int, future_action_window_size: int = 0) -> Dict:
    ...
    # Keep all timesteps as valid chunk anchors. Any future action index that would exceed the
    # trajectory end is clamped to the last valid action (repeat-last padding).
